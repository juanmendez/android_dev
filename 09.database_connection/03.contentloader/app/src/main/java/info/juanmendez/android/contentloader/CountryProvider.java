...
public class CountryProvider extends ContentProvider{
    ...
    public static final String AUTHORITY = "info.juanmendez.android.contentloader.CountryProvider";
    public static final Uri URILOC;

    static{
        URILOC = Uri.parse( "content://" + AUTHORITY );
    }
    ...
    static final HashMap<String, String> LIST_PROJECTION_MAP;

    static{
        LIST_PROJECTION_MAP = new HashMap<String, String>();
        LIST_PROJECTION_MAP.put( OpenHelper.NAME, OpenHelper.NAME + " as " + OpenHelper.NAME );
        LIST_PROJECTION_MAP.put( OpenHelper.ID , OpenHelper.ID + " as " + BaseColumns._ID);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch ( uriMatcher.match(uri))
        {
            ...
            case SINGLE_ROW:
                ...
                sqLiteQueryBuilder.setProjectionMap( LIST_PROJECTION_MAP );
            break;
            case ALLROWS:
                sqLiteQueryBuilder.setProjectionMap( LIST_PROJECTION_MAP );
                break;
