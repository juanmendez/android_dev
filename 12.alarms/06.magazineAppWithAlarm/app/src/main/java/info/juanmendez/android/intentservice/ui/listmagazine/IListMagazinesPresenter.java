 ...
 */
public interface IListMagazinesPresenter extends NetworkUpdate, MagazineListProxy.UiCallBack, DownloadProxy.UiCallback, LoaderManager.LoaderCallbacks<ArrayList<Magazine>> {
