...
public class SuperSizeActivity extends AppCompatActivity {
    ...
    private void superSizeMe() {
        ...
        b.setAutoCancel(true)
                ...
                .addAction(android.R.drawable.star_big_on, "Wiki that burger!", createPendingIntent(WikiThatBurger.class));

        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB)
            b.setContentIntent(createPendingIntent(WikiThatBurger.class));
        else
