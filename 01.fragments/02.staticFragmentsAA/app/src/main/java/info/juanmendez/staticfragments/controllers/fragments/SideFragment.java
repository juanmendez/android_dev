...
public class SideFragment extends Fragment {
    ...
    protected void setTextRef(EditText editText)
    {
        this.textRef = editText;
    }
    ...
    public void receiveValue( int value )
    {
        if( value > 0 )
        {
            textRef.setText(Integer.toString(value));
        }
    }
    ...
    protected void hideKeyboard()
    {
        ...
        imm.hideSoftInputFromWindow( textRef.getWindowToken(), 0 );
    }
